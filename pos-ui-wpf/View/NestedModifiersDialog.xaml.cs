...
{
    public partial class NestedModifiersDialog : OptimizedDialogBase
    {
        public NestedModifiersDialog()
        {
            InitializeComponent();
        ...
        private void ConfigureScrollViewerForTouch(ScrollViewer scrollViewer)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[Touch] NestedModifiersDialog scroll setup error: {ex.Message}");
            }
        }
    }
}
