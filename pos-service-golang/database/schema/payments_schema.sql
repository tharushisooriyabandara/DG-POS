CREATE TABLE `dg_pos_payments` (
    ...
    `card_transaction_token` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `payments` (
    ...
    `payment_method_id` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
